  ...
  details: [
    {
      id: 'INTP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FINTP.svg?alt=media&token=6fbad12a-3922-44c6-8070-f8eac04adf58',
      text: 'Nhà Tư Duy',
      description:
        'Họ thích những học thuyết và tin rằng mọi thứ đều có thể được phân tích và cải thiện, vì vậy họ không quan tâm đến thế giới trần tục và những điều thực tế khác – họ nghĩ rằng nó ít thú vị hơn so với những ý tưởng hoặc hành trình theo đuổi kiến thức.',
    },
    {
      id: 'ENTP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FENTP.svg?alt=media&token=143652da-d19c-4036-837e-9d5c9c195efa',
      text: 'Người Có Tầm Nhìn Xa',
      description:
    ...
    },
    {
      id: 'ESTJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FESTJ.svg?alt=media&token=56fe2dcd-a624-4388-a4e9-09b1fa6c3e0c',
      text: 'Người Giám Sát',
      description:
    ...
    },
    {
      id: 'ENTJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FENTJ.svg?alt=media&token=494cc127-b395-4a24-bd88-ca76ba393c84',
      text: 'Nhà Điều Hành',
      description:
    ...
    },
    {
      id: 'INTJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FINTJ.svg?alt=media&token=25be11e2-f257-4b5b-9870-511c3a6cd675',
      text: 'Nhà Khoa Học',
      description:
    ...
    },
    {
      id: 'INFP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FINFP.svg?alt=media&token=9bf4c63a-4830-4664-8bfe-87902de974a8',
      text: 'Người Duy Tâm',
      description:
    ...
    },
    {
      id: 'ISFJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FISFJ.svg?alt=media&token=cb5c6da9-e845-4288-9beb-cfd124e16ab8',
    ...
    },
    {
      id: 'INFJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FINFJ.svg?alt=media&token=05b78a37-eef6-4687-be59-afa5a6d95e79',
      text: 'Nhà Che Chở',
      description:
    ...
    },
    {
      id: 'ESFJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FESFJ.svg?alt=media&token=4eb74a51-cdfd-4fe7-aff5-420f8e0d24f1',
      text: 'Người Quan Tâm',
      description:
    ...
    },
    {
      id: 'ISFP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FISFP.svg?alt=media&token=9b145286-47e0-458b-9434-99d71a382166',
      text: 'Nhà Kỹ Thuật',
      description:
    ...
    },
    {
      id: 'ESTP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FESTP.svg?alt=media&token=b38e8b2e-5473-4e51-9b6d-92247deb6759',
      text: 'Người Thực Thi',
      description:
    ...
    },
    {
      id: 'ESFP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FESFP.svg?alt=media&token=3ac76f8d-8960-4467-bea8-61b87324a004',
    ...
    },
    {
      id: 'ENFJ',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FENFJ.svg?alt=media&token=28ee49d2-a5ae-48e4-8d0c-0686c4311f64',
      text: 'Người Chỉ Dạy',
      description:
    ...
    },
    {
      id: 'ENFP',
      image:
        'https://firebasestorage.googleapis.com/v0/b/upload-file-5908d.appspot.com/o/mbti%2FENFP.svg?alt=media&token=2b18ce9a-00ec-4a35-8cf5-5cfa7b9f5ef8',
