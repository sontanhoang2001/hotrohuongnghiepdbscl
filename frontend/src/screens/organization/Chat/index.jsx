...
function OrganizationChat() {
  ...
  const [modalCreateChanel, setModalCreateChanel] = useState(false);
  const [modalRenameChanel, setModalRenameChanel] = useState(false);
      ...
      <LeftContent>
        <LeftContentHeader>
          ...
          <UsergroupAddOutlined
            className="add-new-group-chat"
            onClick={() => setModalCreateChanel(true)}
          />
          <Modal
            title="Tạo kênh chat"
            centered
            open={modalCreateChanel}
            onOk={() => setModalCreateChanel(false)}
            onCancel={() => setModalCreateChanel(false)}
          >
            <Input className="header-search" placeholder="Nhập tên kênh..." />
            <p>some contents...</p>
            <p>some contents...</p>
          </Modal>
        </LeftContentHeader>
        ...
        <RightContentHeader>
          ...
          <Rightinfo>
            <RightChatName>
              Tôn Ngộ Không{' '}
              <EditOutlined
                className="rename-btn-chat"
                onClick={() => setModalRenameChanel(true)}
              />
            </RightChatName>
          ...
          <Modal
            title="Đổi tên kênh chat"
            // centered
            open={modalRenameChanel}
            onOk={() => setModalRenameChanel(false)}
            onCancel={() => setModalRenameChanel(false)}
            footer={false}
          >
            <Input className="header-search" placeholder="Nhập tên kênh..." />
          </Modal>
