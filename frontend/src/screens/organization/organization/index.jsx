...
function Organization() {
    ...
    },
    {
      ...
      render: (record) => (
        <>
          <div className="author-info">
            <Button type="text">
              <span onClick={() => handleEdit(record.id)} style={{ color: 'green' }}>
                edit
              </span>
            </Button>
            {/* <Button
              type="text"
              danger
              onClick={() => handleDelete(university.OrganizationDetail.id)}
            >
              <DeleteOutlined />
            </Button> */}
          </div>
  ...
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.id}</Title>
  //         </div>
  //       </>
  //     ),
  //     name: (
  ...
  //             shape="square"
  //             size={40}
  //             src={university.OrganizationDetail.image}
  //           ></Avatar>
  //           <div className="avatar-info">
  //             <Title level={5}>{university.name}</Title>
  //             <p>{university.OrganizationDetail.email}</p>
  ...
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.rank}</Title>
  //         </div>
  //       </>
  //     ),
  //     url: (
  ...
  //           <Title level={5}>
  //             <a
  //               href={university.OrganizationDetail.url}
  //               rel="noopener noreferrer"
  //               target="_blank"
  //             >
  //               {university.OrganizationDetail.url}
  //             </a>
  //           </Title>
  //         </div>
  //       </>
  ...
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.address}</Title>
  //         </div>
  //       </>
  //     ),
  //     province: (
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.province}</Title>
  //         </div>
  //       </>
  //     ),
  //     phone: (
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.phone}</Title>
  //         </div>
  //       </>
  //     ),
  //     lat: (
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.lat}</Title>
  //         </div>
  //       </>
  //     ),
  //     long: (
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.long}</Title>
  //         </div>
  //       </>
  //     ),
  //     description: (
  //       <>
  //         <div className="author-info">
  //           <Title level={5}>{university.OrganizationDetail.description}</Title>
  //         </div>
  //       </>
  //     ),
  //   };
